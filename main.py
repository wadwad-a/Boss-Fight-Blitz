...
fire_icon = pygame.image.load("assets/icons/fire.png")
fire_icon = pygame.transform.scale(fire_icon, (50, 50))
explosion_icon = pygame.image.load("assets/icons/explosion.png")
explosion_icon = pygame.transform.scale(explosion_icon, (50, 50))
volcano_icon = pygame.image.load("assets/icons/volcano.png")
volcano_icon = pygame.transform.scale(volcano_icon, (50, 50))
breadboard_icon = pygame.image.load("assets/icons/breadboard.png")
breadboard_icon = pygame.transform.scale(breadboard_icon, (50, 50))
emerald_icon = pygame.image.load("assets/icons/emerald.png")
emerald_icon = pygame.transform.scale(emerald_icon, (50, 50))
helm_icon = pygame.image.load("assets/icons/helm.png")
helm_icon = pygame.transform.scale(helm_icon, (50, 50))
lifesaver_icon = pygame.image.load("assets/icons/lifesaver.png")
lifesaver_icon = pygame.transform.scale(lifesaver_icon, (50, 50))
dice_icon = pygame.image.load("assets/icons/dice.png")
